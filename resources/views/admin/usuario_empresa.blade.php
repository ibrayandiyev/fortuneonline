                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="form" method="post" action="{{url('susuario_empresa')}}">
                                        @csrf
                                            <div class="list-group">
                                                <div class="list-group-item py-3" data-acc-step>
                                                    <h5 class="mb-0" data-acc-title>Registro Único de Contribuyentes</h5>
                                                    <div data-acc-content>
                                                        <div class="my-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text" class="form-control" name="nr" id="nr" placeholder="Número de ruc">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Razón social</label>
                                                                <input required type="text" class="form-control" name="rz" id="rz" placeholder="Razon social">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Giro de negocio</label>
                                                                <input required type="text" class="form-control" name="gn" id="gn" placeholder="Giro de negocio">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="list-group-item py-3" data-acc-step>
                                                    <h5 class="mb-0" data-acc-title>Datos representante legal</h5>
                                                    <div data-acc-content>
                                                ...
                                                <div class="list-group-item py-3" data-acc-step>
                                                    <h5 class="mb-0" data-acc-title>Datos adicionales</h5>
                                                    <div data-acc-content>
                                                        <div class="my-3">
                                                            <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input required type="text" class="form-control" name="dirf" id="dirf" placeholder="Dirección fiscal">
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="form-label">Telefono</label>
                                                                <input type="text" class="form-control" name="tel" maxlength="50"  placeholder="Número de telefono">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Correo electrónico</label>
                                                                <input type="text" class="form-control" name="correo" id="correo" maxlength="35"  placeholder="Correo electrónico" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="list-group-item py-3" data-acc-step>
                                                    <h5 class="mb-0" data-acc-title>Datos de contacto</h5>
                                                    <div data-acc-content>
                                                        <div class="my-3">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    <label class="form-label">Primer nombre</label>
                                                                    <input required type="text" class="form-control" name="pnc" id="pnc" placeholder="Primer nombre">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label class="form-label">Segundo nombre</label>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label class="form-label">Primer Apellido</label>
                                                                    <input type="text" class="form-control" name="apc" placeholder="Primer apellido">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label class="form-label">Segundo Apellido</label>
                                                            ...
                                                            <div class="form-group">
                                                                <select class="form-control select2 custom-select" name="tdc" >
                                                                    @foreach($doc as $do)
                                                                    <option value="{{$do->tiposdocumento_id}}">{{$do->nombre}}</option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-label">Número de documento</label>
                                                                <input required type="text" class="form-control" name="ndc" id="ndc" placeholder="número de documento">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Teléfono de contacto</label>
                                                                <input type="text" class="form-control" name="telc" id="telc" maxlength="35"  placeholder="Número de teléfono de contacto" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
